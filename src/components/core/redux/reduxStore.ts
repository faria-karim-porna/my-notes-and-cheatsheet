...
export type MNACState = ReturnType<typeof RootReducer>;
export type MNACDispatch = typeof AppStore.dispatch;
export const useAppDispatch = () => useDispatch<MNACDispatch>();
export const useAppSelector = createSelectorHook() as TypedUseSelectorHook<MNACState>;
